...
save_path = r'\\nas.ads.mwn.de\ge35haf\TUM-PC\Dokumente\MasterThesis\Code\moku_measurements\time_measurement\test5\\'
...
frequency_list = np.arange(start=1, stop=100e3, )
...
instrument.set_timebase(0, 10e-3)
...
try:
    for voltage in voltage_list:
        ...
        instrument.set_trigger(level=0.00, source='Input1')
        instrument.generate_waveform(1, type='Sine', amplitude=voltage, frequency=1e3, offset=0)
        # time.sleep(0.1)
